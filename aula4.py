...
print(1.1, 10.11) # float -> Sempre separado com . e não ,
print(0.0, -1.5)

# A função type mostra o tipo que o Python inferiu ao valor. Na realidade é uma classe
print(type('Otávio'))
print(type(0))
print(type(1.1), type(1.10), type(0.0))